...
bool HelloWorldSubscriber::init()
{
    ...
    Rparam.topic.topicDataType = "HelloWorldData::Msg";
    Rparam.topic.topicName = "HelloWorldData_Msg";
...
void HelloWorldSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    if(sub->takeNextData((void*)&m_Hello, &m_info))
    {
        if(m_info.sampleKind == ALIVE)
        {
            ...
            std::cout << "Message "<<m_Hello.message()<< " "<< m_Hello.userID()<< " RECEIVED"<<std::endl;
        }
    }
